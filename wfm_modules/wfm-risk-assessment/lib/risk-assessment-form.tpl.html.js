...
ngModule.run(['$templateCache', function ($templateCache) {
  $templateCache.put('wfm-template/risk-assessment-form.tpl.html',
    ...
    '    </div>\n' +
    '    <button class="button button-balanced button-full" on-touch="ctrl.answerComplete(true)">Yes</button>\n' +
    '    <button class="button button-assertive button-full" on-touch="ctrl.answerComplete(false)">No</button>\n' +
    '  </div>\n' +
